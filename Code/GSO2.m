...
%%% GSO2 is a infer master TFs using GSO via L2,0 regularization model integrating transcriptomes and TF binding information. 
...
while si<=SQI(2);
    ...
    movefile('XHard.txt',newdir); movefile(newdir,'GSO2');
    
    fprintf('The routine of sparsity level s=%d  completes.\r\n',s)
    si=si+1;
end
newdir = sprintf('GSO2'); mkdir('Output'); movefile(newdir,'Output');