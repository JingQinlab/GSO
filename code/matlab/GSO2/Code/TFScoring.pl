...
##It should be run in the output folder of GSO or gLASSO, in which output matrices XHard.txt.name.tf or XSoft.txt.name.tf should be in a list of folders, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s12, s14, s16, s18, s20.
